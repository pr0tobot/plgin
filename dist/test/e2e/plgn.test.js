...
describe('PLGN E2E Tests', () => {
    ...
    describe('Agent', () => {
        ...
        it('should extract feature from source code', async () => {
            ...
            await writeFile(join(sourceDir, 'index.ts'), `export function greet(name: string): string {
  return \`Hello, \${name}!\`;
}
...
`;
    ...
    describe('Pack Creator', () => {
        it('should create pack from source', async () => {
            ...
            await mkdir(sourceDir, { recursive: true });
            await writeFile(join(sourceDir, 'auth.js'), `export function authenticate(credentials) {
...
`);
    ...
    describe('Pack Integrator', () => {
        ...
        it('should integrate pack with adaptation', async () => {
            ...
            await mkdir(sourceDir, { recursive: true });
            await writeFile(join(sourceDir, 'util.ts'), 'export const capitalize = (s: string) => s.charAt(0).toUpperCase() + s.slice(1);');
    ...
    describe('Registry', () => {
        ...
        it('should discover packs by language', async () => {
            ...
            const pythonPacks = await discoverPacks({ language: 'python' }, TEST_CONFIG.defaults);
    ...
    describe('Multi-language Support', () => {
        it('should handle JavaScript to TypeScript adaptation', async () => {
            ...
            await mkdir(sourceDir, { recursive: true });
            await writeFile(join(sourceDir, 'module.js'), 'module.exports = { add: (a, b) => a + b };');
...
//# sourceMappingURL=plgn.test.js.map